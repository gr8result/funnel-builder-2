...
async function runCompleteScan(settings, account = null) {
  ...
  const scanSummary = {
    ...
    universeDefinition: "Finnhub US common-stock symbols cross-checked against active/tradable Alpaca US equity assets, then filtered by validated Alpaca OHLCV.",
    ...
    dataProvider: "Alpaca",
    feed: "IEX",
    coverageDisclosure: "Limited exchange feed",
