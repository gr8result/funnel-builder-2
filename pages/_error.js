...
function CustomError({ statusCode }) {
  ...
  return (
    <SafeErrorShell
      ...
      message={code === 404
        ? "This page is unavailable. No account details are shown on error pages."
        : "An unexpected error occurred. No account details are shown on error pages."}
    />
  );
}
...
CustomError.disableLayout = true;
