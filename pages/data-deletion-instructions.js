export default function DataDeletionInstructions() {
  return (
    <div style={{ maxWidth: 800, margin: '60px auto', padding: '0 24px', fontFamily: 'system-ui, sans-serif', color: '#5f9af9', lineHeight: 1.7 }}>
      <h1 style={{ fontSize: 48, fontWeight: 600, marginBottom: 8 }}>Data Deletion Instructions</h1>
      <p style={{ color: '#fafcff', marginBottom: 32 }}>Last updated: April 9, 2026</p>
      ...
      <ol style={{ paddingLeft: 20 }}>
        <li>Go to your <a href="https://www.facebook.com/settings?tab=applications" style={{ color: '#f4f5f7' }}>Facebook App Settings</a></li>
      ...
      <p>Email us at <a href="mailto:support@gr8result.com" style={{ color: '#ffffff' }}>support@gr8result.com</a> with the subject line <strong>"Data Deletion Request"</strong> and we will delete all your data within 30 days and send you a confirmation.</p>
