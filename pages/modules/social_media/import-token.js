...
const S = {
  ...
  title:   { fontSize: 26, fontWeight: 700, color: '#E9D5FF', marginBottom: 6, marginTop: 0 },
  sub:     { fontSize: 14, color: '#9CA3AF', marginBottom: 28, lineHeight: 1.7 },
  label:   { display: 'block', fontSize: 13, color: '#9CA3AF', marginBottom: 6, fontWeight: 600 },
  input:   { width: '100%', background: 'rgba(0,0,0,0.45)', border: '1px solid rgba(167,169,250,0.25)', borderRadius: 8, color: '#F3F0FF', padding: '10px 14px', fontSize: 14, outline: 'none', fontFamily: 'inherit', boxSizing: 'border-box', marginBottom: 16 },
  btn:     { padding: '11px 28px', borderRadius: 9, background: 'rgba(124,58,237,0.8)', border: '1px solid rgba(167,169,250,0.4)', color: '#fff', fontWeight: 700, fontSize: 15, cursor: 'pointer', width: '100%' },
  ok:      { padding: '12px 16px', borderRadius: 10, background: 'rgba(16,185,129,0.2)', border: '1px solid rgba(16,185,129,0.4)', color: '#6EE7B7', marginBottom: 16, fontSize: 14 },
  err:     { padding: '12px 16px', borderRadius: 10, background: 'rgba(239,68,68,0.2)', border: '1px solid rgba(239,68,68,0.4)', color: '#FCA5A5', marginBottom: 16, fontSize: 14 },
  steps:   { background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(253,224,71,0.2)', borderRadius: 12, padding: '18px 22px', marginBottom: 28 },
  stepTtl: { fontSize: 14, fontWeight: 700, color: '#FCD34D', marginBottom: 12, marginTop: 0 },
  ol:      { color: '#D8B4FE', fontSize: 14, lineHeight: 2.2, paddingLeft: 20, margin: 0 },
  a:       { color: '#93C5FD', textDecoration: 'underline' },
  or:      { textAlign: 'center', color: '#6B7280', fontSize: 13, margin: '20px 0', position: 'relative' },
        ...
        <div style={S.card}>
          ...
          {result && result.length > 0 && (
            <div style={S.ok}>
              ...
              <div style={{ marginTop: 10 }}>
                <button style={{ ...S.btn, background: 'rgba(16,185,129,0.4)', width: 'auto', padding: '8px 18px', fontSize: 13 }}
          ...
          <div style={S.steps}>
            ...
            <ol style={S.ol}>
              ...
              <li style={{ color: '#FCA5A5', fontWeight: 700 }}>⚠️ Do NOT check <code>manage_pages</code> — it is deprecated and will break the entire request</li>
          ...
          {result && result.length === 0 && (
            <div style={{ marginTop: 14, padding: '14px 16px', background: 'rgba(251,191,36,0.1)', border: '1px solid rgba(251,191,36,0.3)', borderRadius: 10, fontSize: 13, color: '#FCD34D', lineHeight: 1.8 }}>
          ...
          <hr style={S.divider} />
          <button style={{ ...S.btn, background: 'transparent', border: '1px solid rgba(255,255,255,0.1)', color: '#9CA3AF', fontSize: 13 }}
            onClick={() => router.back()}>
            ← Back
          </button>
        </div>
