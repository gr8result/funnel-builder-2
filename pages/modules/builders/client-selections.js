...
export default function RetiredInclusionsSelectionsPage() {
  return (
    <>
      <Head>
      ...
      <main style={styles.page}>
        <section style={styles.panel}>
          ...
          <p style={styles.copy}>
            Historical records are preserved. The retired product-first interface is no longer available.
          </p>
        </section>
      </main>
    </>
...
RetiredInclusionsSelectionsPage.disableLayout = true;
