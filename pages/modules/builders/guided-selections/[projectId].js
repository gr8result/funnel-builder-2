...
export default function RetiredGuidedInclusionsSelectionsPage() {
  return (
    <>
      <Head>
      ...
      <main style={styles.page}>
        <section style={styles.panel}>
          ...
          <p style={styles.copy}>
            Historical records are preserved. The retired guided selections workspace is no longer available.
          </p>
        </section>
      </main>
    </>
