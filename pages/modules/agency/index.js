    ...
    <div style={styles.wrap}>
      <div style={styles.inner}>
          ...
          <div style={styles.bannerLeft}>
            ...
            <div>
              ...
              <p style={styles.bannerDesc}>
                Manage all your client sub-accounts in one place.
              </p>
            </div>
          </div>
          <Link href="/dashboard">
        ...
        <div style={styles.comingSoonBox}>
          ...
          <p style={styles.comingSoonDate}>Expected Delivery: June / July 2026</p>
          <p style={styles.comingSoonDesc}>
            The Agency Dashboard will let you provision and manage multiple client accounts from a single admin view
            with per-client billing, module access control, usage reporting, and white-label support.
          </p>
          <div style={styles.featureGrid}>
            {[
              { icon: "🏢", label: "Client Sub-Accounts" },
              { icon: "💳", label: "Per-Client Billing" },
              { icon: "🔒", label: "Module Access Control" },
              { icon: "📊", label: "Usage Reporting" },
              { icon: "🎨", label: "White-Label Support" },
              { icon: "🔗", label: "API Access Management" },
            ].map((f) => (
...
const styles = {
  ...
  comingSoonDate: { margin: "0 0 20px", fontSize: 18, color: "#10b981", fontWeight: 600 },
  comingSoonDesc: {
    margin: "0 auto 36px",
    fontSize: 18,
    opacity: 0.75,
