...
["GuidedRoofingWorkflow", "roofingConfiguration", "Complete Section", "tileManufacturer", "roofing-tile-product-step", 'data-roofing-home-cards="fascia-gutter colorbond roof-tiles"', 'FASCIA_GUTTER_VISUAL_URL = "/images/product-library/roofing/fascia-gutter.jpg"', "Matt is only available"].forEach((needle) => {
