...
drop policy if exists "standard inclusions owners can read" on public.standard_inclusions_documents;
...
drop policy if exists "standard inclusions owners can insert" on public.standard_inclusions_documents;
create policy "standard inclusions owners can insert"
  on public.standard_inclusions_documents
  for insert
  with check (auth.uid() = owner_user_id);

drop policy if exists "standard inclusions owners can update" on public.standard_inclusions_documents;
