...
import { resolveBaseStandardInclusionsTemplate } from "../standard-inclusions/masterTemplate.js";
...
export function createEstimateBuilderWorkbookDefaults(plannerAnswers = {}, options = {}) {
  ...
  return {
    ...
    standardInclusions: createDefaultStandardInclusions("local-builder", {
      documentBuilder: options.standardInclusionsBaseDocument || null,
    }),
...
export async function createEstimateBuilderWorkbookDefaultsWithBaseTemplate(plannerAnswers = {}, options = {}) {
  const builderId = options.builderId || "local-builder";
  const workbookId = options.workbookId || "";
  const standardInclusionsBaseDocument = options.standardInclusionsBaseDocument || await resolveBaseStandardInclusionsTemplate({
    builderId,
    workbookId,
    workspaceId: options.workspaceId || "",
    authHeaders: options.authHeaders || {},
  });
  return createEstimateBuilderWorkbookDefaults(plannerAnswers, { ...options, standardInclusionsBaseDocument });
}
