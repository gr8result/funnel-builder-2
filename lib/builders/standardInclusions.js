...
export function normaliseStandardInclusions(value = {}, builderId = "local-builder") {
  ...
  const documentBuilder = value.documentBuilder || null;
  ...
  const deleted = hasDocumentPages || hasOnlyOfficeDocument ? false : Boolean(value.scheduleDeleted || value.isDeleted);
  return {
    selectedPackageId,
