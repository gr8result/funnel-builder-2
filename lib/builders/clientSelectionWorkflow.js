...
export const EXTERIOR_REQUIREMENTS = [
  ...
  requirement("gutters-fascia", "Gutters & Fascia", "gutters-fascia", 0, "ITEM", 1, "exterior", "Exterior", "gutters"),
  ...
  requirement("exterior-paint", "Exterior Paint", "exterior-paint", 0, "ITEM", 1, "exterior", "Exterior", "exteriorPaint"),
...
export function createSelectionPayloadFromProduct({ workspaceId, projectId, snapshotId, sessionId, requirement, product, userId = null, quantity } = {}) {
  ...
  return {
    ...
    selected_details: {
      ...
      glazing: entity.attributes?.glazing || product.attributes?.glazing || "",
      hardwareCompatibility: entity.attributes?.hardwareCompatibility || product.attributes?.hardwareCompatibility || "",
      selectedPrice,
      allowance,
      ...
      officialProductURL: entity.officialProductURL || product.product_url || product.productUrl || "",
    },
    status: "selected",
