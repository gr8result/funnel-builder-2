...
//
// NOTE: "subaccounts" has been removed — the platform uses a workspace model,
//       not an agency/subaccount model.
...
const MODULES_BASE = [
  ...
  // "subaccounts" removed — use workspaces instead (built-in to all plans)
];
