...
import { getWorkspaceDemoState } from "./demoWorkspace";
...
export function withWorkspace(handler, options = {}) {
  ...
  return async function (req, res) {
    ...
    const demoState = await getWorkspaceDemoState(workspaceId);
    req.workspace = demoState.workspace;
    req.isDemoWorkspace = demoState.isDemo;
