...
function buildProjectHubTemplate(theme = "modern-blue") {
  const dashboardMockup = "https://placehold.co/1200x780/111827/38bdf8?text=Project+Hub+Dashboard";
  const ganttMockup = "https://placehold.co/1200x780/15162b/a78bfa?text=Gantt+Timeline+%2B+Dependencies";
  const estimatorMockup = "https://placehold.co/1200x780/10251f/22c55e?text=Estimator+%2B+Proposal+Builder";
  const jobBoardMockup = "https://placehold.co/1200x780/2b1908/f97316?text=Drag+and+Drop+Job+Board";
  const heroImage = "https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=1800&q=85";
  const teamImage = "https://images.unsplash.com/photo-1551836022-d5d88e9218df?auto=format&fit=crop&w=1400&q=85";
  const constructionImage = "https://images.unsplash.com/photo-1541888946425-d81bb19240f5?auto=format&fit=crop&w=1400&q=85";

  const richList = (intro, items) => [
    `<p>${intro}</p>`,
    "<ul>",
  ...
  return {
    ...
    site: {
      ...
      nav: [
        ...
        { label: "Gantt Chart", href: "#gantt-chart" },
    ...
    pages: [
      templatePage(
        ...
        "Project Hub",
        [
          directBlock(BlockTypes.NAV_BAR, {
            brand: "GR8 Result",
            showLogo: true,
            variant: "split-dark",
            stickyMode: "sticky-transparent",
            fullWidthBackground: true,
            links: [
              { label: "Project Hub", href: "#project-hub", highlighted: true },
              { label: "Estimator", href: "#estimator" },
              { label: "Gantt Chart", href: "#gantt-chart" },
              { label: "Job Board", href: "#job-board" },
              { label: "Demo", href: "#demo" },
            ...
            textColor: "#e5eefb",
            buttonColor: "linear-gradient(135deg,#22c55e,#38bdf8)",
            buttonTextColor: "#03111f",
            borderColor: "rgba(148,163,184,0.24)",
          }),
          directBlock(BlockTypes.HERO, {
            eyebrow: "Project Hub",
            headline: "Plan Jobs, Track Progress & Deliver Projects On Time",
            headlineBlock: {
              content: "Plan Jobs, Track Progress & Deliver Projects On Time",
              fontSize: 66,
              fontWeight: "900",
              lineHeight: 1.04,
              color: "#ffffff",
            ...
            subheadline: "Bring estimates, job boards, Gantt charts, tasks, documents and project workflows together in one powerful command centre built for growing trade, building and service businesses.",
            bodyBlock: {
              content: "Bring estimates, job boards, Gantt charts, tasks, documents and project workflows together in one powerful command centre built for growing trade, building and service businesses.",
              fontSize: 20,
              lineHeight: 1.65,
              color: "#dbeafe",
              alignment: "left",
            ...
            backgroundColor: "linear-gradient(135deg,#020617,#111827 52%,#1e1b4b)",
            backgroundOverlayColor: "#020617",
            backgroundOverlayOpacity: 0.72,
            buttonColor: "linear-gradient(135deg,#22c55e,#38bdf8)",
            buttonTextColor: "#02111f",
          ...
          directBlock(BlockTypes.TEXT, {
            text: '<h2>Your Complete Project Command Centre</h2><p>The Project Hub gives your team one central place to manage work from quote approval through to completion. Create project plans, assign tasks, track progress, manage documents, monitor deadlines and keep every job moving without relying on scattered spreadsheets, whiteboards or disconnected apps.</p>',
            fullWidthBackground: true,
            backgroundColor: "linear-gradient(180deg,#020617,#08111f)",
            textColor: "#e5eefb",
            textFontSize: 20,
            textLineHeight: 1.7,
            alignment: "center",
          ...
          directBlock(BlockTypes.FEATURE_LIST, {
            title: "Three Powerful Tools Working Together",
            layout: "columns",
            featureVariant: "cards",
            featureCardWidth: 360,
            fullWidthBackground: true,
            backgroundColor: "linear-gradient(180deg,#08111f,#111827)",
            itemBackgroundColor: "rgba(15,23,42,0.92)",
            ...
            items: [
              {
                title: "Estimator",
                body: richList("Create accurate estimates faster with professional itemised pricing, labour, materials, margins, variations and client-ready proposals. Turn approved estimates into live projects without re-entering the same information twice.", [
                  "Itemised quote builder",
                  "Labour, materials and margin control",
                  "Variations and optional extras",
                  "Professional client proposals",
                  "Convert approved quotes into projects",
                ]),
                image: estimatorMockup,
              },
              {
                title: "Gantt Chart",
                body: richList("Plan every stage with confidence by visualising project timelines, dependencies, milestones and deadlines in a clear Gantt chart. See what needs to happen, when it needs to happen and which tasks are holding up the job.", [
              ...
              {
                title: "Job Board",
                body: richList("Keep every job moving with a visual board for organising tasks, assigning team members, setting priorities and moving work through each stage of production. Everyone can see what is pending, in progress, on hold and completed.", [
                  "Drag-and-drop task board",
                  "Task assignments",
                  "Status columns",
                  "Due dates and priorities",
                  "Comments, documents and updates",
                ]),
                image: jobBoardMockup,
              },
            ],
          }),
          directBlock(BlockTypes.STATS, {
            title: "From Estimate to Completion",
            subtitle: "A connected workflow that carries the job from first price through planning, delivery and reporting.",
            statsVariant: "data-ribbon",
            fullWidthBackground: true,
            backgroundColor: "linear-gradient(135deg,#0f172a,#1e1b4b 50%,#064e3b)",
            textColor: "#f8fafc",
            accentColor: "#38bdf8",
            stats: [
              { number: "01", label: "Estimate Created", detail: "Build the scope, costs, margins and client-ready proposal." },
              { number: "02", label: "Client Approved", detail: "Move the approved quote into delivery without duplicating admin." },
              { number: "03", label: "Project Started", detail: "Create the live project, team responsibilities and initial timeline." },
              { number: "04", label: "Tasks Assigned", detail: "Send work into clear status columns with owners and priorities." },
              { number: "05", label: "Timeline Tracked", detail: "Monitor dependencies, milestones, deadlines and progress." },
              { number: "06", label: "Job Completed", detail: "Close the job with clear records, final updates and reporting visibility." },
            ],
          }),
          directBlock(BlockTypes.STATS, {
            title: "Built for Real Project-Based Businesses",
            subtitle: "Less admin, fewer missed details, clearer communication and better control across every active job.",
            statsVariant: "editorial-band",
            fullWidthBackground: true,
            backgroundColor: "linear-gradient(180deg,#111827,#020617)",
            textColor: "#f8fafc",
            cardBackgroundColor: "rgba(15,23,42,0.9)",
            borderColor: "rgba(148,163,184,0.2)",
            accentColor: "#f97316",
            stats: [
              { number: "Admin", label: "Save hours every week", detail: "Cut down double entry, status chasing and spreadsheet updates." },
              { number: "Dates", label: "Reduce missed deadlines", detail: "See blocked tasks, delayed stages and upcoming milestones sooner." },
              { number: "Team", label: "Improve communication", detail: "Keep owners, office staff and field teams working from one source of truth." },
              { number: "Profit", label: "Keep projects profitable", detail: "Connect scope, estimates, variations and delivery activity." },
              { number: "Flow", label: "Track every stage", detail: "Follow jobs from quote approval through completion and reporting." },
              { number: "Owner", label: "Better visibility", detail: "Give business owners the live project picture without extra meetings." },
            ],
          }),
          directBlock(BlockTypes.FEATURE_LIST, {
            title: "Connected With the Rest of Your Platform",
            layout: "columns",
            featureVariant: "minimal",
            featureCardWidth: 250,
            fullWidthBackground: true,
            backgroundColor: "linear-gradient(180deg,#020617,#08111f)",
            itemBackgroundColor: "rgba(255,255,255,0.06)",
            borderColor: "rgba(148,163,184,0.2)",
            textColor: "#e5eefb",
            headingAlign: "center",
            items: [
              { title: "CRM", body: "Connect leads, clients and project records.", image: "https://placehold.co/800x520/172554/60a5fa?text=CRM" },
              { title: "Calendar", body: "Keep bookings, deadlines and project dates aligned.", image: "https://placehold.co/800x520/1e1b4b/a78bfa?text=Calendar" },
              { title: "Documents", body: "Keep proposals, files, photos and updates close to the job.", image: "https://placehold.co/800x520/064e3b/34d399?text=Documents" },
              { title: "Email & SMS", body: "Send updates, reminders and client messages from the platform.", image: "https://placehold.co/800x520/7c2d12/f97316?text=Email+SMS" },
              { title: "Reporting", body: "See project status, activity and performance in one place.", image: "https://placehold.co/800x520/0f172a/38bdf8?text=Reporting" },
              { title: "Team Members", body: "Manage team access, ownership and project responsibilities together.", image: "https://placehold.co/800x520/312e81/c4b5fd?text=Team+Members" },
            ],
          }),
          directBlock(BlockTypes.COLUMNS_2, {
            title: "Estimator in Detail",
            leftTitle: "Create accurate estimates without rebuilding the job later",
            leftContent: "<p>The estimator gives your team a structured place to build client-ready quotes with itemised pricing, labour, materials, markups, margins, variations and optional extras. It is designed for real quoting workflows where a small change in scope can affect materials, labour and profitability.</p><p>Once a quote is approved, the same information can carry into the project workflow so the team is not manually retyping scope, tasks and client details. That means less admin, fewer mistakes and a cleaner handover from sales to delivery.</p><ul><li>Itemised quote builder</li><li>Labour, materials and margin control</li><li>Variations and optional extras</li><li>Professional client proposals</li><li>Convert approved quotes into projects</li></ul>",
            rightImage: estimatorMockup,
            ratio: "50-50",
            fullWidthBackground: true,
            backgroundColor: "linear-gradient(180deg,#08111f,#0f172a)",
            cardBackgroundColor: "rgba(15,23,42,0.74)",
            textColor: "#f8fafc",
            borderColor: "rgba(34,197,94,0.28)",
          }),
          directBlock(BlockTypes.COLUMNS_2, {
            title: "Gantt Chart in Detail",
            leftImage: ganttMockup,
            rightTitle: "Plan every dependency, deadline and milestone",
            rightContent: "<p>The Gantt chart turns complex delivery into a visual timeline your team can understand quickly. You can map stages, dependencies, milestones and dates so everyone knows what needs to happen, what is waiting on another task and where the schedule is exposed.</p><p>This is especially useful for construction, trade and service businesses where procurement, site access, subcontractors and approvals can shift the plan. Project Hub helps teams stay ahead of delays instead of reacting after the deadline has already slipped.</p><ul><li>Project timeline planning</li><li>Task dependencies</li><li>Milestones and deadlines</li><li>Resource allocation</li><li>Progress tracking</li></ul>",
            ratio: "50-50",
            fullWidthBackground: true,
            backgroundColor: "linear-gradient(180deg,#0f172a,#111827)",
            cardBackgroundColor: "rgba(17,24,39,0.82)",
            textColor: "#f8fafc",
            borderColor: "rgba(167,139,250,0.3)",
          }),
          directBlock(BlockTypes.COLUMNS_2, {
            title: "Job Board in Detail",
            leftTitle: "Give the team a live production board",
            leftContent: "<p>The Job Board gives every project a clear operational view. Tasks can move through pending, in progress, on hold and completed stages, with priorities, due dates, comments, documents and updates visible where the work is happening.</p><p>Instead of chasing status through calls, notes and disconnected tools, the team can see the work queue at a glance. Owners get visibility, supervisors get control and office staff can keep clients informed with less back-and-forth.</p><ul><li>Drag-and-drop task board</li><li>Task assignments</li><li>Status columns</li><li>Due dates and priorities</li><li>Comments, documents and updates</li></ul>",
            rightImage: jobBoardMockup,
            ratio: "50-50",
            fullWidthBackground: true,
            backgroundColor: "linear-gradient(180deg,#111827,#020617)",
            cardBackgroundColor: "rgba(15,23,42,0.82)",
            textColor: "#f8fafc",
            borderColor: "rgba(249,115,22,0.3)",
          }),
          directBlock(BlockTypes.IMAGE_STACK, {
            title: "Project Hub command centre",
            fullWidthBackground: true,
            backgroundColor: "linear-gradient(135deg,#020617,#0f172a 45%,#042f2e)",
            minHeight: "680px",
            images: [
              { id: "hub-stack-team", kind: "image", src: teamImage, x: 42, y: 58, width: 390, height: 270, rotation: -5, radius: 26, zIndex: 1 },
              { id: "hub-stack-site", kind: "image", src: constructionImage, x: 510, y: 84, width: 430, height: 300, rotation: 4, radius: 26, zIndex: 2 },
              { id: "hub-stack-dashboard", kind: "image", src: dashboardMockup, x: 230, y: 308, width: 560, height: 300, rotation: 0, radius: 26, zIndex: 3 },
              { id: "hub-stack-copy", kind: "text", content: "Estimates, timelines, tasks and reporting in one connected project workspace.", x: 780, y: 405, width: 300, height: 160, rotation: -2, radius: 24, zIndex: 4, fontSize: 25, fontWeight: "800", textAlign: "left", verticalAlign: "center", textColor: "#f8fafc", background: "rgba(15,23,42,0.86)" },
            ],
          }),
          directBlock(BlockTypes.HERO, {
            eyebrow: "Project Hub",
            headline: "Ready to Take Control of Every Project?",
            headlineBlock: {
              content: "Ready to Take Control of Every Project?",
              fontSize: 52,
              fontWeight: "900",
              lineHeight: 1.08,
              color: "#ffffff",
            ...
            subheadline: "Start planning, tracking and delivering jobs with one connected system built to help your business save time, stay organised and scale with confidence.",
            bodyBlock: {
              content: "Start planning, tracking and delivering jobs with one connected system built to help your business save time, stay organised and scale with confidence.",
              fontSize: 20,
              lineHeight: 1.6,
              color: "#e0f2fe",
              alignment: "center",
            ...
            fullWidthBackground: true,
            backgroundColor: "linear-gradient(135deg,#111827,#1d4ed8 52%,#22c55e)",
            headlineColor: "#ffffff",
            textColor: "#ffffff",
            buttonColor: "linear-gradient(135deg,#f97316,#facc15)",
          ...
          directBlock(BlockTypes.TEXT, {
            text: "Project Hub by GR8 Result. Plan jobs, track progress and deliver projects on time.",
            alignment: "center",
        ...
        "Market the Project Hub module with editable SaaS sections for estimator, Gantt chart, job board, benefits, integrations and calls to action."
      ),
    ],
  };
}
...
export const TEMPLATES = [
  ...
  {
    slug: "website-project-hub",
    type: "website",
    name: "Project Hub",
    blurb: "Dark premium SaaS page for the Project Hub module with estimator, Gantt chart, job board, workflow, integrations and CTA sections.",
    thumb:
      "https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=1200&q=80",
    build: (theme) => buildProjectHubTemplate(theme),
  },
    // --- Animated/External Templates ---
    {
      ...
      thumb: "/templates/gallery/framer-animated-portfolio/preview.png",
      build: (theme) => {
