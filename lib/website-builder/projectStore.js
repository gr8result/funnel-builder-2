...
import { normalizeSharedBlockTemplateProject, resolveSharedBlockInstance } from "./sharedBlockTemplates";
...
function buildHtmlFromBlock(block, project) {
  ...
  switch (block?.type) {
    ...
    case BlockTypes.HERO: {
      ...
      const primaryTarget = primaryCta.newTab || props.ctaNewTab ? ` target="_blank" rel="noopener noreferrer"` : "";
      const secondaryTarget = secondaryCta.newTab || props.secondaryCtaNewTab ? ` target="_blank" rel="noopener noreferrer"` : "";
    ...
    case BlockTypes.CTA_BUTTON: {
      ...
      const targetAttrs = props.openInNewTab || props.newTab || props.targetBlank ? ` target="_blank" rel="noopener noreferrer"` : "";
