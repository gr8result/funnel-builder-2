...
function prepareProjectContent(project) {
  ...
  const baseProject = {
    ...project,
    globalNavBlock: project?.globalNavBlock || templateOverride?.globalNavBlock || null,
    globalFooterBlock: project?.globalFooterBlock || templateOverride?.globalFooterBlock || null,
  };
