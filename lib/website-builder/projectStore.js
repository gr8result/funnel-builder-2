...
import { buildFooterLinksFromPages, buildFooterNavigationContext, footerBlockToGlobalFooter, globalFooterToFooterBlock, normalizeFooterNavigationBlock } from "./footerNavigation";
...
function normalizeGlobalBlocks(project) {
  ...
  if (project.globalFooterBlock && project.globalFooterBlock.type !== BlockTypes.FOOTER) {
    ...
    const nextFooterBlock = normalizeFooterNavigationBlock(project.globalFooterBlock, footerContext);
