...
import { buildFooterLinksFromPages, buildFooterNavigationContext, normalizeFooterNavigationBlock } from "./footerNavigation";
...
function normalizeStoredBlock(block, options = {}) {
  ...
  if (type === BlockTypes.FOOTER) {
    ...
    if (currentNavLinks.length === 0 && !currentProps.footerNavManual) {
      ...
      if (pageLinks.length) nextProps.navLinks = pageLinks;
    }
  }
