...
function ensureBuilderEnablementsForCandidates(products = [], builderProducts = [], organisationId = "", candidates = []) {
  ...
  const repairedBuilderProducts = builderProducts.map((item) => {
    ...
    if (!repairStaleDisabledRefs || isExplicitlyDisabledBuilderReference(item)) return item;
    return {
      ...item,
      enabled: true,
      active: true,
...
export function ensureDemoBuilderBrickEnablements(products = [], builderProducts = [], organisationId = DEMO_BUILDER_ORGANISATION_ID) {
  ...
  return ensureBuilderEnablementsForCandidates(products, builderProducts, organisationId, activeQldBrickMasterProducts(products));
}
...
export function ensureDemoBuilderRoofingEnablements(products = [], builderProducts = [], organisationId = DEMO_BUILDER_ORGANISATION_ID) {
  if (organisationId !== DEMO_BUILDER_ORGANISATION_ID) return builderProducts;
  return ensureBuilderEnablementsForCandidates(products, builderProducts, organisationId, activeAuMetalRoofingMasterProducts(products));
}
...
export function ensureBuilderCladdingEnablements(products = [], builderProducts = [], organisationId = "") {
  return ensureBuilderEnablementsForCandidates(products, builderProducts, organisationId, activeCladdingMasterProducts(products));
}
