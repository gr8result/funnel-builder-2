...
const BASE_PRODUCT_FAMILIES = [
  ...
  family({
    ...
    sourceMatchers: ["KITCHEN LIGHT", "LIGHTING", "PENDANT", "DOWNLIGHT"],
    unit: "ITEM",
    quantityRule: "Selected as kitchen light fittings or lighting package; quantities follow electrical schedule.",
    ...
    imageRequirement: "Kitchen light fitting or reviewed family image required.",
    pricingMode: "quote-required-or-allowance-only",
  ...
  family({
    ...
    topLevelArea: "kitchen",
    category: "Paint",
    subcategory: "Kitchen Paint",
    sourceMatchers: ["KITCHEN PAINT", "WALL PAINT", "PAINT"],
    unit: "ITEM",
    ...
    imageRequirement: "Paint product image, colour swatch or reviewed kitchen paint image required.",
    pricingMode: "quote-required-or-allowance-only",
