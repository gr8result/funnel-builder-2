import { PRICE_BANDS, SELECTION_VISIBILITY_SET, TIER_RANK } from "./constants.js";
...
export function normalizeSelectionVisibilityCsv(value, fallback = "client_selectable") {
  const key = slugify(value);
  if (!key) return fallback;
  return SELECTION_VISIBILITY_SET.has(key) ? key : null;
}
