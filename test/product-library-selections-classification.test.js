...
test("Product Library defaults to client selectable catalogue filters", () => {
  ...
  assert.match(page, /Choose products, finishes and fixtures for project inclusions and client selections\./);
  assert.match(page, /Back to Project Dashboard/);
  assert.match(page, /Open Existing Job/);
  assert.match(page, /Search products\.\.\./);
  ...
  assert.match(page, /600 mm/);
  assert.match(page, /900 mm/);
