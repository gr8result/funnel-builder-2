...
const products: ProductReference[] = [
  { id: "product_dev_floor_covering", organisationId: "org_dev", name: "Development Floor Covering", brand: "DevSpec", supplierId: "supplier_dev_finishes", defaultVariantId: "variant_dev_floor_oak", unit: "m2", active: true, compatibility: { category: "flooring", internalExternal: "internal" }, unitCost: money(450) },
  { id: "product_dev_internal_door_hardware", organisationId: "org_dev", name: "Development Internal Door Hardware", brand: "DevLock", supplierId: "supplier_dev_fixtures", defaultVariantId: "variant_dev_handle_brushed", unit: "set", active: true, compatibility: { category: "hardware", subtype: "door_hardware", internalExternal: "internal" }, unitCost: money(120) },
  { id: "product_dev_basin_mixer", organisationId: "org_dev", name: "Development Basin Mixer", brand: "DevTap", supplierId: "supplier_dev_fixtures", defaultVariantId: "variant_dev_basin_chrome", unit: "each", active: true, compatibility: { category: "plumbing", subtype: "basin_mixer", internalExternal: "internal" }, unitCost: money(590) },
  { id: "product_dev_kitchen_mixer", organisationId: "org_dev", name: "Development Kitchen Sink Mixer", brand: "DevTap", supplierId: "supplier_dev_fixtures", defaultVariantId: "variant_dev_kitchen_chrome", unit: "each", active: true, compatibility: { category: "plumbing", subtype: "sink_mixer", internalExternal: "internal" }, unitCost: money(640) },
  { id: "product_dev_laundry_mixer", organisationId: "org_dev", name: "Development Laundry Mixer", brand: "DevTap", supplierId: "supplier_dev_fixtures", defaultVariantId: "variant_dev_laundry_chrome", unit: "each", active: true, compatibility: { category: "plumbing", subtype: "laundry_mixer", internalExternal: "internal" }, unitCost: money(360) },
