...
const suppliers: SupplierReference[] = [
  ...
  { id: "supplier_demo_generic", organisationId: "org_dev", name: "Demonstration Supplier" },
...
const products: ProductReference[] = [
  ...
  { id: "demo_generic_stone_benchtop", organisationId: "org_dev", productCode: "DEMO-SEL-KIT-BENCH-20-STANDARD", name: "Demonstration Product - Generic Stone Range", brand: "Demonstration Brand", range: "Generic Stone Range", supplierId: "supplier_demo_generic", defaultVariantId: "demo_generic_stone_white", requiresVariant: true, unit: "m2", active: true, compatibility: { category: "fixture", subtype: "benchtops", requirementTags: ["benchtop", "stone-benchtop"], internalExternal: "internal" }, priceSource: "Demonstration product - no verified commercial price", imageUrl: "/assets/builders/standard-inclusions-premier-kitchen.webp", colourSwatchImageUrl: "/assets/builders/standard-inclusions-premier-kitchen.webp", productUrl: "https://example.com/demonstration-product/generic-stone-range", description: "Demonstration Product. Replace with the builder's supplier, brand, range, colours, images, links and prices." },
  { id: "demo_generic_metal_roofing", organisationId: "org_dev", productCode: "DEMO-SEL-EXT-ROOF-METAL", name: "Demonstration Product - Generic Metal Roof", brand: "Demonstration Brand", range: "Generic Metal Roof", supplierId: "supplier_demo_generic", defaultVariantId: "demo_generic_roof_mid", requiresVariant: true, unit: "m2", active: true, compatibility: { category: "external_finish", subtype: "roof_material", requirementTags: ["roofing", "metal-roof", "roof-material"], internalExternal: "external" }, priceSource: "Demonstration product - no verified commercial price", imageUrl: "/standard-inclusions/assets/image45.jpeg", colourSwatchImageUrl: "/standard-inclusions/assets/image45.jpeg", productUrl: "https://example.com/demonstration-product/generic-metal-roof", description: "Demonstration Product. Builder catalogues can provide any metal roofing supplier, brand, profile, range, colour and finish." },
  { id: "demo_generic_brick_range", organisationId: "org_dev", productCode: "DEMO-SEL-EXT-BRICK", name: "Demonstration Product - Generic Brick Range", brand: "Demonstration Brand", range: "Generic Brick Range", supplierId: "supplier_demo_generic", defaultVariantId: "demo_generic_brick_red_brown", requiresVariant: true, unit: "m2", active: true, compatibility: { category: "external_finish", subtype: "brick_or_cladding", requirementTags: ["brick", "brick-or-cladding"], internalExternal: "external" }, priceSource: "Demonstration product - no verified commercial price", imageUrl: "/standard-inclusions/assets/image49.jpeg", colourSwatchImageUrl: "/standard-inclusions/assets/image49.jpeg", productUrl: "https://example.com/demonstration-product/generic-brick-range", description: "Demonstration Product. Replace with builder-specific supplier, brand, collection, brick, colour, texture and format." },
  { id: "demo_generic_internal_door_standard", organisationId: "org_dev", productCode: "DEMO-SEL-INT-DOOR-STANDARD", name: "Demonstration Product - Generic Internal Door", brand: "Demonstration Brand", range: "Standard Internal Doors", supplierId: "supplier_demo_generic", defaultVariantId: "demo_generic_door_flush_820_paint", requiresVariant: true, unit: "each", active: true, compatibility: { category: "fixture", subtype: "internal_doors", requirementTags: ["internal-door", "standard-internal-door"], internalExternal: "internal" }, priceSource: "Demonstration product - no verified commercial price", imageUrl: "/standard-inclusions/assets/image50.png", colourSwatchImageUrl: "/standard-inclusions/assets/image50.png", productUrl: "https://example.com/demonstration-product/generic-internal-door", description: "Demonstration Product. The standard template supports any internal door manufacturer selected by the builder." },
  { id: "demo_generic_internal_door_premium", organisationId: "org_dev", productCode: "DEMO-SEL-INT-DOOR-PREMIUM", name: "Demonstration Product - Generic Premium Internal Door", brand: "Demonstration Brand", range: "Premium Internal Doors", supplierId: "supplier_demo_generic", defaultVariantId: "demo_generic_door_moulded_820_paint", requiresVariant: true, unit: "each", active: true, compatibility: { category: "fixture", subtype: "internal_doors", requirementTags: ["internal-door", "premium-internal-door"], internalExternal: "internal" }, priceSource: "Demonstration product - no verified commercial price", imageUrl: "/standard-inclusions/assets/image50.png", colourSwatchImageUrl: "/standard-inclusions/assets/image50.png", productUrl: "https://example.com/demonstration-product/generic-premium-internal-door", description: "Demonstration Product. Premium internal doors are a generic family, not a permanent supplier." },
...
const variants: ProductVariantReference[] = [
  ...
  { id: "demo_generic_stone_white", productReferenceId: "demo_generic_stone_benchtop", name: "White / 20 mm / Pencil Round", sku: "DEMO-STONE-WHITE", active: true, colour: "White", finish: "Polished", size: "20 mm", productUrl: "https://example.com/demonstration-product/generic-stone-range" },
  { id: "demo_generic_stone_light_grey", productReferenceId: "demo_generic_stone_benchtop", name: "Light Grey / 20 mm / Pencil Round", sku: "DEMO-STONE-LGREY", active: true, colour: "Light Grey", finish: "Polished", size: "20 mm", productUrl: "https://example.com/demonstration-product/generic-stone-range" },
  { id: "demo_generic_stone_dark_grey", productReferenceId: "demo_generic_stone_benchtop", name: "Dark Grey / 40 mm / Mitred", sku: "DEMO-STONE-DGREY", active: true, colour: "Dark Grey", finish: "Honed", size: "40 mm", productUrl: "https://example.com/demonstration-product/generic-stone-range" },
  { id: "demo_generic_roof_light", productReferenceId: "demo_generic_metal_roofing", name: "Light / Corrugated / Standard", sku: "DEMO-ROOF-LIGHT", active: true, colour: "Light", finish: "Standard", size: "0.42 BMT", productUrl: "https://example.com/demonstration-product/generic-metal-roof" },
  { id: "demo_generic_roof_mid", productReferenceId: "demo_generic_metal_roofing", name: "Mid-tone / Corrugated / Standard", sku: "DEMO-ROOF-MID", active: true, colour: "Mid-tone", finish: "Standard", size: "0.42 BMT", productUrl: "https://example.com/demonstration-product/generic-metal-roof" },
  { id: "demo_generic_roof_dark", productReferenceId: "demo_generic_metal_roofing", name: "Dark / Standing Seam / Matt", sku: "DEMO-ROOF-DARK", active: true, colour: "Dark", finish: "Matt", size: "0.48 BMT", productUrl: "https://example.com/demonstration-product/generic-metal-roof" },
  { id: "demo_generic_brick_light", productReferenceId: "demo_generic_brick_range", name: "Light / Smooth / Standard", sku: "DEMO-BRICK-LIGHT", active: true, colour: "Light", finish: "Smooth", size: "Standard", productUrl: "https://example.com/demonstration-product/generic-brick-range" },
  { id: "demo_generic_brick_red_brown", productReferenceId: "demo_generic_brick_range", name: "Red/Brown / Textured / Standard", sku: "DEMO-BRICK-RED-BROWN", active: true, colour: "Red/Brown", finish: "Textured", size: "Standard", productUrl: "https://example.com/demonstration-product/generic-brick-range" },
  { id: "demo_generic_brick_charcoal", productReferenceId: "demo_generic_brick_range", name: "Charcoal / Textured / Long Format", sku: "DEMO-BRICK-CHARCOAL", active: true, colour: "Charcoal", finish: "Textured", size: "Long Format", productUrl: "https://example.com/demonstration-product/generic-brick-range" },
  { id: "demo_generic_door_flush_820_paint", productReferenceId: "demo_generic_internal_door_standard", name: "Flush Panel / 820 x 2040 / Paint Grade", sku: "DEMO-DOOR-FLUSH-820", active: true, colour: "Paint Grade", finish: "Primed", size: "820 x 2040 x 35", width: "820 mm", productUrl: "https://example.com/demonstration-product/generic-internal-door" },
  { id: "demo_generic_door_moulded_820_paint", productReferenceId: "demo_generic_internal_door_premium", name: "Moulded Panel / 820 x 2040 / Paint Grade", sku: "DEMO-DOOR-MOULDED-820", active: true, colour: "Paint Grade", finish: "Primed", size: "820 x 2040 x 35", width: "820 mm", productUrl: "https://example.com/demonstration-product/generic-premium-internal-door" },
  { id: "demo_generic_door_glazed_820_paint", productReferenceId: "demo_generic_internal_door_premium", name: "Glazed / 820 x 2040 / Paint Grade", sku: "DEMO-DOOR-GLAZED-820", active: true, colour: "Paint Grade", finish: "Primed", size: "820 x 2040 x 35", width: "820 mm", productUrl: "https://example.com/demonstration-product/generic-premium-internal-door" },
];
