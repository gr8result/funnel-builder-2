...
export async function runSelectionReviewTests(): Promise<void> {
  ...
  assert(reviewSource.includes("/inclusions-selections/approvals"), "Ready project reaches approvals placeholder.");
  assert(approvalsSource.includes("Client and builder approvals will be completed in the next stage."), "Approvals placeholder text should be exact.");
