...
assert.deepEqual(pageToScreenPoint(planPoint.x, planPoint.y, viewState), screenPoint);
assert.deepEqual(screenToPagePoint(screenPoint.x, screenPoint.y, viewState), planPoint);
